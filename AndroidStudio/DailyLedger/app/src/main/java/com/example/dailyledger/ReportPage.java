...
public class ReportPage extends AppCompatActivity {
    ...
    int selectedEndYear, selectedEndMonth, selectedEndDay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterBtn = findViewById(R.id.searchBtn);
        sharetxt = findViewById(R.id.rsharetxt);
        viewtxt  =findViewById(R.id.rviewtxt);
        ...
        viewtxt.setOnClickListener(view -> {
            generatePDFReport(dataEntries);
            Intent i = new Intent(ReportPage.this,ViewPDF.class);
    ...
    public void fetchData(RecyclerView recyclerView){
        ...
        Query query;
        if (filtermode.equals("Report")) {
            query = dataEntriesRef.orderBy("Date", Query.Direction.DESCENDING).limit(10);
        }else {
            query = dataEntriesRef.whereEqualTo("OrderStatus", filtermode).orderBy("Date", Query.Direction.DESCENDING).limit(10);
        }
...
//                    Log.d("Firestore", "Data Entry: " + dataEntry.toString());
                ...
                DataEntryAdapter adapter = new DataEntryAdapter(ReportPage.this,dataEntries);
...
//                progressDialog.dismiss();
    ...
    public void fetchDataByDate(RecyclerView recyclerView,String userID){
        ...
        if (filtermode.equals("Report")) {
            ...
            query = dataEntriesRef.whereEqualTo("OrderStatus", filtermode).whereGreaterThanOrEqualTo("Date", StartD)
                    .whereLessThanOrEqualTo("Date", EndD).orderBy("Date", Query.Direction.DESCENDING);
        }
...
//                    dataEntry.setEntryId(document.getId());
    ...
    public void showStartDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(ReportPage.this, new DatePickerDialog.OnDateSetListener() {
    ...
    private void generatePDFReport(List<DataEntryModel> dataEntries) {
        ...
        Toast.makeText(ReportPage.this, filePath.toString(), Toast.LENGTH_SHORT).show();
